...
Good:
GET /api/v1/users/{id}
GET /api/v1/store/prices/{order-id}
POST /api/v1/domains
PUT /api/v1/domains/{id}
DELETE /api/v1/domains/{id}

Bad:
GET /api/v1/list-domains
POST /api/v1/get-users
POST /api/v1/create-domain
POST /api/v1/update-domain
```
...
Bad:
POST /api/v1/deploy-function
POST /api/v1/activate-domain
```
